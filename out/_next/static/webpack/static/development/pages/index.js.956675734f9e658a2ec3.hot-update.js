...
/* harmony import */ var _utils_colors__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../utils/colors */ "./utils/colors.ts");
...
function singleCountryChart(title, data) {
  return __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_7__["Card"], {
    ...
    data: data,
    stroke: _utils_colors__WEBPACK_IMPORTED_MODULE_13__["COLOR_CONFIRMED_CASES_HEX"],
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 86,
    ...
    dataKey: "Tests",
    data: data,
    stroke: _utils_colors__WEBPACK_IMPORTED_MODULE_13__["COLOR_TESTS_HEX"],
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 87,
    ...
    dataKey: "Deaths",
    data: data,
    stroke: _utils_colors__WEBPACK_IMPORTED_MODULE_13__["COLOR_DEATHS_HEX"],
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 88,
...
/***/ "./pages/components/singleKPICard.tsx":
/*!********************************************!*\
  !*** ./pages/components/singleKPICard.tsx ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SingleKPICard; });
/* harmony import */ var _babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/esm/createClass */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
/* harmony import */ var _babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime/helpers/esm/assertThisInitialized */ "./node_modules/@babel/runtime/helpers/esm/assertThisInitialized.js");
/* harmony import */ var _babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inherits */ "./node_modules/@babel/runtime/helpers/esm/inherits.js");
...
/* harmony import */ var numeral__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! numeral */ "./node_modules/numeral/numeral.js");
...
var _jsxFileName = "/Users/jamiechung/Development/COVID/scotland-covid-dashboard/pages/components/singleKPICard.tsx";
...
var SingleKPICard = /*#__PURE__*/function (_React$Component) {
  Object(_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_3__["default"])(SingleKPICard, _React$Component);

  var _super = _createSuper(SingleKPICard);

  function SingleKPICard() {
    var _this;

    Object(_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, SingleKPICard);
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SingleKPICard, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;

      axios__WEBPACK_IMPORTED_MODULE_9___default.a.get(_utils_utilities__WEBPACK_IMPORTED_MODULE_11__["createbaseURLWithQuery"](this.props.query)).then(function (response) {
        _this2.setState({
    ...
    value: function render() {
      ...
      }, numeral__WEBPACK_IMPORTED_MODULE_10___default()(this.state.value).format('0,0'))) : __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_8__["LinearProgress"], {
        __self: this,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 32,
...
/***/ "./pages/utils/colors.ts":
false,

/***/ "./pages/utils/utilities.ts":
false,
...
/*!*************************!*\
  !*** ./utils/colors.ts ***!
  \*************************/
/*! exports provided: COLOR_CONFIRMED_CASES_HEX, COLOR_TESTS_HEX, COLOR_DEATHS_HEX */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "COLOR_CONFIRMED_CASES_HEX", function() { return COLOR_CONFIRMED_CASES_HEX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "COLOR_TESTS_HEX", function() { return COLOR_TESTS_HEX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "COLOR_DEATHS_HEX", function() { return COLOR_DEATHS_HEX; });
var COLOR_CONFIRMED_CASES_HEX = '#B6B0FF';
var COLOR_TESTS_HEX = '#3049AD';
var COLOR_DEATHS_HEX = '#FF994E';
...
/*!****************************!*\
  !*** ./utils/utilities.ts ***!
  \****************************/
/*! exports provided: createBaseWithDB, createbaseURLWithQuery */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createBaseWithDB", function() { return createBaseWithDB; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createbaseURLWithQuery", function() { return createbaseURLWithQuery; });
function createBaseWithDB(db) {
  return 'https://covid-19-uk-datasette-65tzkjlxkq-ew.a.run.app/' + db + '.json';
}
function createbaseURLWithQuery(query) {
...
//# sourceMappingURL=index.js.956675734f9e658a2ec3.hot-update.js.map