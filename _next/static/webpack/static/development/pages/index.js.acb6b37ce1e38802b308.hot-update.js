...
/* harmony import */ var csvtojson__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! csvtojson */ "./node_modules/csvtojson/browser/browser.js");
/* harmony import */ var csvtojson__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(csvtojson__WEBPACK_IMPORTED_MODULE_16__);
...
var AreaExpansionPanelDetail = /*#__PURE__*/function (_React$Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(AreaExpansionPanelDetail, [{
    ...
    value: function componentDidMount() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.all([axios__WEBPACK_IMPORTED_MODULE_9___default.a.get(_utils_utilities__WEBPACK_IMPORTED_MODULE_15__["createbaseURLWithQuery"](_utils_queries__WEBPACK_IMPORTED_MODULE_14__["QUERY_TOTAL_CASES_BY_AREA"].replace('##AREA##', this.props.area).replace('##AREACODE##', this.props.areaCode))), axios__WEBPACK_IMPORTED_MODULE_9___default.a.get('https://raw.githubusercontent.com/watty62/Scot_covid19/master/data/processed/regional_hospitalisations.csv')]).then(axios__WEBPACK_IMPORTED_MODULE_9___default.a.spread(function (total_cases, regional_hospitalizations) {
        var _build_data = []; // hyrate array of JSON object with rows based on the columns

        lodash__WEBPACK_IMPORTED_MODULE_10__["map"](total_cases.data.rows, function (r) {
        ...
        csvtojson__WEBPACK_IMPORTED_MODULE_16___default()({
          checkType: true
        }).fromString(regional_hospitalizations.data).then(function (json) {
          _this2.setState({
            data_regional_hospitalizatons: json
          });
        });
      })).then(function () {
        _this2.setState({
    ...
    value: function render() {
      return this.state.ready ? __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_7__["Container"], {
      ...
      }, "Total Cases"), __jsx(recharts__WEBPACK_IMPORTED_MODULE_12__["ResponsiveContainer"], {
        width: "100%",
        height: 200,
        __self: this,
        __source: {
      ...
      }))), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_7__["Divider"], {
        variant: "middle",
        __self: this,
        __source: {
          fileName: _jsxFileName,
      ...
      }, "Total Hospitalizations"), __jsx(recharts__WEBPACK_IMPORTED_MODULE_12__["ResponsiveContainer"], {
        width: "100%",
        height: 200,
        __self: this,
        __source: {
        ...
        data: this.state.data_regional_hospitalizatons,
        __self: this,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 90,
        ...
        type: "monotone",
        fill: _utils_chartcolors__WEBPACK_IMPORTED_MODULE_13__["COLOR_PBI_DEFAULT"][1],
...
//# sourceMappingURL=index.js.acb6b37ce1e38802b308.hot-update.js.map