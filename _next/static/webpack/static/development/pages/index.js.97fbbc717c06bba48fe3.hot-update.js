...
var AreaExpansionPanelDetail = /*#__PURE__*/function (_React$Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(AreaExpansionPanelDetail, [{
    ...
    value: function componentDidMount() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_10___default.a.get(_utils_utilities__WEBPACK_IMPORTED_MODULE_11__["createbaseURLWithQuery"](_utils_queries__WEBPACK_IMPORTED_MODULE_12__["QUERY_TOTAL_CASES_BY_AREA"])).then(function (response) {
        var _build_data = []; // hyrate array of JSON object with rows based on the columns

        lodash__WEBPACK_IMPORTED_MODULE_13__["map"](response.data.rows, function (r) {
          _build_data.push(lodash__WEBPACK_IMPORTED_MODULE_13__["mapKeys"](r, function (v, k) {
    ...
    value: function render() {
      ...
      }, "Population: 122,124"), __jsx(recharts__WEBPACK_IMPORTED_MODULE_15__["ResponsiveContainer"], {
        width: "100%",
        height: 500,
        __self: this,
        __source: {
      ...
      }), __jsx(recharts__WEBPACK_IMPORTED_MODULE_15__["Brush"], {
        dataKey: "date",
        height: 30,
        stroke: "#8884d8",
        __self: this,
      ...
      }))))) : __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_9__["LinearProgress"], {
        __self: this,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 63,
...
//# sourceMappingURL=index.js.97fbbc717c06bba48fe3.hot-update.js.map