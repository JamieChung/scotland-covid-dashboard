...
/***/ "./pages/components/singleTrendCard.tsx":
/*!**********************************************!*\
  !*** ./pages/components/singleTrendCard.tsx ***!
  \**********************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SingleTrendCard; });
...
var _jsxFileName = "/Users/jamiechung/Development/COVID/scotland-covid-dashboard/pages/components/singleTrendCard.tsx";
...
var SingleTrendCard = /*#__PURE__*/function (_React$Component) {
  Object(_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_3__["default"])(SingleTrendCard, _React$Component);

  var _super = _createSuper(SingleTrendCard);

  function SingleTrendCard() {
    var _this;

    Object(_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, SingleTrendCard);
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SingleTrendCard, [{
    ...
    value: function componentDidMount() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.get('https://raw.githubusercontent.com/watty62/Scot_covid19/master/data/processed/intensive_care.csv').then(function (response) {
        csvtojson__WEBPACK_IMPORTED_MODULE_10___default()().fromString(response.data).then(function (json) {
          _this2.setState({
            value: json,
            ready: true
          });
...
//# sourceMappingURL=index.js.200210938c440370f551.hot-update.js.map