  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(StaffAbsencesCard, [{
    ...
    value: function componentDidMount() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.get('https://raw.githubusercontent.com/watty62/Scot_covid19/master/data/processed/staff_absences.csv').then(function (response) {
        csvtojson__WEBPACK_IMPORTED_MODULE_9___default()().fromString(response.data).then(function (json) {
          _this2.setState({
            value: lodash__WEBPACK_IMPORTED_MODULE_13__["mapKeys"](json, function (value, key) {
              return key.replace(' ', '');
            }),
            ready: true
          });
...
//# sourceMappingURL=index.js.949083f64027e194b76e.hot-update.js.map