...
var AreaExpansionPanelDetail = /*#__PURE__*/function (_React$Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(AreaExpansionPanelDetail, [{
    ...
    value: function componentDidMount() {
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.all([axios__WEBPACK_IMPORTED_MODULE_9___default.a.get(_utils_utilities__WEBPACK_IMPORTED_MODULE_14__["createbaseURLWithQuery"](_utils_queries__WEBPACK_IMPORTED_MODULE_13__["QUERY_TOTAL_CASES_BY_AREA"])), axios__WEBPACK_IMPORTED_MODULE_9___default.a.get('https://github.com/watty62/Scot_covid19/blob/master/data/processed/regional_hospitalisations.csv')]).then(axios__WEBPACK_IMPORTED_MODULE_9___default.a.spread(function (total_cases, regional_hospitalizations) {
        console.log(total_cases);
        console.log(regional_hospitalizations);
      })); // .spread(...responses => {
      // let _build_data = [];
    ...
    value: function render() {
      ...
      }, "Population: 122,124"), __jsx(recharts__WEBPACK_IMPORTED_MODULE_11__["ResponsiveContainer"], {
        width: "100%",
        height: 500,
        __self: this,
        __source: {
...
//# sourceMappingURL=index.js.2c9f6f88fa3430a28f99.hot-update.js.map